...
#
#
vgg = VGG16(weights='imagenet', include_top=False, input_shape=x_train.shape[1:], pooling='max')
...
mc = ModelCheckpoint('hand_sanitizer_pretrained1.h5', monitor='val_accuracy', mode='max', verbose=1, save_best_only=True)
